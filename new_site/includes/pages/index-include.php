        ...
        <div class="row banner-header">
            <div class="col-xs-12 text-center">
                <div class="my-profile">
                    ...
                    <div class="col-sm-4">
                        <a class="btn cta-button-linkedin" role="button" href="https://www.linkedin.com/in/wictorstenseke/" target="_blank">LinkedIn&nbsp;&nbsp;&nbsp;<i class="fa fa-linkedin-square " aria-hidden="true"></i></a>
                    </div>
                </div>
