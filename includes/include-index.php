  ...
  <div class="portfolio-wrapper">
    ...
    <div class="pure-g hogelid-info">
      <div class="pure-u-md-1-2 pure-u-1 project-image hogelid-image">
        <a href="/projekt/bokningssystem.php"><img class="zoom-hogelid" src="img/hogelid1.png" alt="Bild på webbplats för bokning av tennisbana på Högelids Tennisklubb."></a>
      </div>
      <div class="pure-u-md-1-2 pure-u-1 project-info">
        <div class="info-content">
          <h2 class="text-center zoom-hogelid"><a href="/projekt/bokningssystem.php">Bokningssystem</a></h2>
          ...
          <a href="/projekt/bokningssystem.php" class="text-center project-button button">Läs mer</a>
    ...
    <div class="pure-g noizier-info">
      <div class="pure-u-md-1-2 pure-u-1 project-image noizier-image">
        <a href="projekt/webbplats.php"><img class="zoom-noizier" src="img/noizier-mockup2.png" alt="Bild på webbplats för en ljudtekniker."></a>
      </div>
      <div class="pure-u-md-1-2 pure-u-1 project-info">
        <div class="info-content">
          <h2 class="text-center zoom-noizier"><a href="projekt/webbplats.php">Webbplats</a></h2>
          ...
          <a href="projekt/webbplats.php" class="text-center project-button button">Läs mer</a>
          <div class="skill-tags">
            <span class="skill-tag first">Sketch</span>
            <span class="skill-tag first">HTML</span>
            <span class="skill-tag">Sass</span>
    ...
    <div class="pure-g blueprint-info">
      <div class="pure-u-md-1-2 pure-u-1 project-image">
        <a href="/projekt/servicedesign.php"><img class="zoom-blueprint" src="img/blueprint4.png" alt="Bild på en Service Blueprint som används inom Service Design."></a>
      </div>
      <div class="pure-u-md-1-2 pure-u-1 project-info">
        <div class="info-content">
          <h2 class="text-center zoom-blueprint"><a href="/projekt/servicedesign.php">Service Design</a></h2>
          ...
          <a href="/projekt/servicedesign.php" class="text-center project-button button">Läs mer</a>
          <div class="skill-tags">
